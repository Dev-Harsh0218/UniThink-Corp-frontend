...
import homebg from '../assets/huge.png';
...
function BookNow() {
    ...
    return (
        <div>
            <div style={{ backgroundImage: `url(${homebg})` }} className="h-[87vh] bg-cover bg-center bg-no-repeat pt-32 pb-10 flex justify-center items-center mt-10 md:mt-0">
                <div className=" max-w-full mx-auto flex flex-col md:flex-row md:items-center gap-36">
                    <div className="flex-1">
                        <div className='font-bold text-3xl md:text-5xl tracking-wide text-center md:text-left'>
                            A Stop for all your needs. <br />
                    ...
                    <div className='flex-1 p-4 bg-gradient-to-b from-orange-100 to-amber-100 border rounded-2xl shadow-lg'>
                        <p className='text-base text-center md:text-left'>Book a session now! Dw! We won't charge you for anything...</p>
